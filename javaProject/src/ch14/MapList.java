...
public class MapList {
	static void print(Map<String, Object> map) {
		ArrayList<Student> list2=(ArrayList<Student>)map.get("list");//map에서는 key값으로 데이터를 불러옴
		for(Student s : list2) {
	...
	public static void main(String[] args) {
		Map<String, Object> map = new HashMap<>();//앱인스턴스 생성
		...
		map.put("list", list);
		print(map);//압축파일처럼 list안의 3개의 객체가 map에 담겨저 print쪽의 매개변수화되어 넘김
	}
}
